  ...
  <body>
        ...
        <div class="offcanvas-body p-0">
            <nav class="navbar-dark">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link" id="createaccount">
                            <i class="icon bi bi-person-add"></i>
                            <span class="text">Cấp tài khoản</span>
                        </a>
                    </li>
                    <li class="nav-item" >
                        <a href="#" class="nav-link" id="manage">
                            <i class="icon bi bi-briefcase"></i>
                            <span class="text">Quản lý dòng sản phẩm</span>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <main>
            <div id="thongke_tab" class="tabcontent">
                <?php include "assests/thongke_executiveboard.php";?>
            </div>
            <div id="createaccount_tab" class="tabcontent text-black">
                <?php include "assests/createaccount_executiveboard.php";?>
            </div>
            <div id="manage_tab" class="tabcontent">
                <?php include "assests/manage_executiveboard.php";?>
            </div>
    
    </main>
    <!-- main -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    <script src="js/executiveboard.js"></script>
  </body>
</html>